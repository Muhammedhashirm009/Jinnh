...
if (config.WORKTYPE == 'private') {
    ...
    if (config.LANG == 'TR' || config.LANG == 'AZ') {
        ...
        Asena.addCommand({pattern: 'htt (.*)', fromMe: true, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'github ?(.*)', fromMe: true, desc: Glang.G陌THUB_DESC }, async (message, match) => {
    ...
    Asena.addCommand({pattern: 'htt (.*)', fromMe: false, desc: Lang.TTS_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.G陌THUB_DESC }, async (message, match) => {
