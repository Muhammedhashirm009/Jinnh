...
if (Config.LANG == 'ML') desc_msg = 'പരിധിയില്ലാത്ത ആക്സസ് ഉള്ള ടെക്സ്റ്റ് മേക്കർ ഉപകരണങ്ങ�? കാണിക്കുന്നു.'
if (Config.LANG == 'HI') desc_msg = 'असीमि�? एक्सेस के सा�? टेक्स्टमेक�? टू�? दिखाता है�?'
